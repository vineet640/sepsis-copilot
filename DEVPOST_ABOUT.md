...
- **Infrastructure is part of the demo**: shipping with optional keys taught us to **degrade gracefully**—cache where it helps, fall back to sensible copy when APIs are offline, and keep Mongo/Solana **optional** for judges who run locally.
...
- **Generative AI**: **Gemini** for explanations (mode-specific tone), chat, simplified wording, and chart narration; **ElevenLabs** for spoken summaries (audio served by the API).
